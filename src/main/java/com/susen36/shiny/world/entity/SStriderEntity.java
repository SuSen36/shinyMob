...
public class SStriderEntity extends Strider {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MOVEMENT_SPEED, (double)0.105F).add(Attributes.KNOCKBACK_RESISTANCE,10).add(Attributes.ARMOR,10).add(Attributes.FOLLOW_RANGE, 16.0D);
    }
}
