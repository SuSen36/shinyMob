...
@OnlyIn(Dist.CLIENT)
public class MushroomCowFungusLayer<T extends SMushroomCowEntity> extends RenderLayer<T, CowModel<T>> {
    private final BlockRenderDispatcher blockRenderer;

    public MushroomCowFungusLayer(RenderLayerParent<T, CowModel<T>> p_234850_, BlockRenderDispatcher p_234851_) {
        super(p_234850_);
    ...
    public void render(PoseStack p_117256_, MultiBufferSource p_117257_, int p_117258_, T p_117259_, float p_117260_, float p_117261_, float p_117262_, float p_117263_, float p_117264_, float p_117265_) {
        if (!p_117259_.isBaby()) {
            ...
            if (!p_117259_.isInvisible() || flag) {
                ...
                p_117256_.pushPose();
                p_117256_.translate(0.2F, -0.125F, -0.055F);
                p_117256_.mulPose(Axis.YP.rotationDegrees(-18.0F));
                p_117256_.scale(-0.5F, -0.5F, 0.5F);
                p_117256_.translate(-0.1F, -0.5F, 0.5F);
                this.renderMushroomBlock(p_117256_, p_117257_, p_117258_, flag, blockstate, i, bakedmodel);
                p_117256_.popPose();
                p_117256_.pushPose();
                p_117256_.translate(0.2F, -0.125F, 0.5F);
                ...
                p_117256_.scale(-0.5F, -0.5F, 0.5F);
                p_117256_.translate(-0.8F, -0.5F, -0.5F);
                this.renderMushroomBlock(p_117256_, p_117257_, p_117258_, flag, blockstate, i, bakedmodel);
                p_117256_.popPose();
                p_117256_.pushPose();
                this.getParentModel().getHead().translateAndRotate(p_117256_);
                p_117256_.translate(0.0F, -0.4F, -0.2F);
                p_117256_.mulPose(Axis.YP.rotationDegrees(-78.0F));
                p_117256_.scale(-0.45F, -0.5F, 0.45F);
                p_117256_.translate(-0.55F, -0.4F, -0.5F);
                this.renderMushroomBlock(p_117256_, p_117257_, p_117258_, flag, blockstate, i, bakedmodel);
                p_117256_.popPose();
            }
        }
